      ...
      <Container className="py-20">
        <div ref={pageRef} className="max-w-4xl mx-auto">
          ...
          <header className="mb-12">
            <h1 className="text-4xl md:text-6xl font-pixel text-[#FFFFFF] mb-6 tracking-wider leading-relaxed">
              {project.title}
            </h1>
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              {project.tags.map((tag) => (
                <span
                  key={tag}
                  className="text-[10px] uppercase tracking-wider font-semibold px-2 py-1 bg-[#1A1A1A] text-[#B0B0B0] border border-[#333333] rounded"
                >
                  {tag}
                </span>
              ))}
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <div className="mt-12 p-8 bg-[#0A0A0A] border border-[#333333] rounded-xl">
                  ...
                  <p className="text-[#B0B0B0] leading-relaxed">
                    This project demonstrates a commitment to high-quality software delivery through
                    rigorous testing and validation. The focus was on ensuring a seamless user
                    experience and robust system stability.
                  </p>
                </div>
              </div>
            </div>
